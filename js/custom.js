...
if(window.console) {
	...
	if(cons) { 
		...
		cons.info("如果有发现什么bug，还请帮忙留言提醒，或者到我的GitHub项目里提交issue哦~ %c(https://github.com/fuxiyuchen-arthur/fuxiyuchen-arthur.github.io)","color:#a517ef;font-weight:bold;");
...
var a = new Array("富强", "民主", "文明", "和谐", "自由", "平等", "公正" ,"法治", "爱国", "敬业", "诚信", "友善",
			...
			"w(·Д·)w", "(#`O′)", "（/TДT)/","(’∇’)シ┳━┳","!!!∑(ﾟДﾟノ)ノ","┭┮﹏┭┮", "_(:3」∠)_",
			"（*゜Д゜）σ凸←自爆按钮 ","(*≧▽≦)ツ┏━┓⌒ 〓▇3:) 睡什么睡，起来嗨！");
